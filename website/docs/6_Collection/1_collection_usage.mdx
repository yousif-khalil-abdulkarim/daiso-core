...
The [`collection`](https://yousif-khalil-abdulkarim.github.io/daiso-core/modules/Collection.html) module provides a fluent, convenient wrapper for working with [`Arrays`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array), [`Iterables`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols#the_iterable_protocol) and [`AsyncIterables`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols#the_async_iterator_and_async_iterable_protocols).

## Creating a collection

You can create a collection from an any object thats implements the [`Iterable`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols#the_iterable_protocol) contract.

Create a collection from an [`Array`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array):
...
Create a collection from a [`Set`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Set):
...
Create a collection from a [`Map`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Map):
...
Create collection from your own object that implements [`Iterable`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols#the_iterable_protocol) contract:
...
Since it is [`Iterable`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols#the_iterable_protocol) you can also use the `for of` loop to iterate over a collection.
...
- [`ListCollection`](https://yousif-khalil-abdulkarim.github.io/daiso-core/classes/Collection.ListCollection.html) implements the [`ICollection`](https://yousif-khalil-abdulkarim.github.io/daiso-core/types/Collection.ICollection.html) contract and uses [`Array`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array) internally.

- [`IterableCollection`](https://yousif-khalil-abdulkarim.github.io/daiso-core/classes/Collection.IterableCollection.html) implements the [`ICollection`](https://yousif-khalil-abdulkarim.github.io/daiso-core/types/Collection.ICollection.html) contract and uses [`Iterable`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols#the_iterable_protocol) internally.
  It only filters and transforms items when you loop through or access its items.

- [`AsyncIterableCollection`](https://yousif-khalil-abdulkarim.github.io/daiso-core/classes/Collection.AsyncIterableCollection.html) implements the [`IAsyncCollection`](https://yousif-khalil-abdulkarim.github.io/daiso-core/types/Collection.IAsyncCollection.html) contract and uses [`AsyncIterable`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols#the_async_iterator_and_async_iterable_protocols) internally.
  It only filters and transforms items when you loop through or access its items.

    :::danger
    Note [`AsyncIterableCollection`](https://yousif-khalil-abdulkarim.github.io/daiso-core/classes/Collection.AsyncIterableCollection.html) uses [`LazyPromise`](https://yousif-khalil-abdulkarim.github.io/daiso-core/classes/Async.LazyPromise.html) instead of a regular `Promise`.
    This means you must either `await` the [`LazyPromise`](https://yousif-khalil-abdulkarim.github.io/daiso-core/classes/Async.LazyPromise.html) or call its `defer` method to run it. Refer to the [`LazyPromise documentation`](/docs/8_Async/1_lazy_promise.md) for further information.
    :::

## Serialization and deserialization

The [`ListCollection`](https://yousif-khalil-abdulkarim.github.io/daiso-core/classes/Collection.ListCollection.html) and [`IterableCollection`](https://yousif-khalil-abdulkarim.github.io/daiso-core/classes/Collection.IterableCollection.html) classes supports serialization and deserialization, allowing you to easily convert instances to and from serialized formats. However, registration is required first:
...
console.log(
    listCollection.toArray(),
    deserializedListCollection.toArray(),
);
...
For the remaining of the documentation, we'll discuss each method available on the [`ICollection`](https://yousif-khalil-abdulkarim.github.io/daiso-core/types/Collection.ICollection.html) contract.
...
The `append` method adds [`Iterable`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols#the_iterable_protocol) to the end of the collection.
...
```ts
import type { ListCollection } from "@daiso-tech/core/collection/collection";
...
The `insertAfter` method adds [`Iterable`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols#the_iterable_protocol) after the first item that matches `predicateFn`.
...
The `insertBefore` method adds [`Iterable`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols#the_iterable_protocol) before the first item that matches `predicateFn`.
...
The `prepend` method adds [`Iterable`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols#the_iterable_protocol) to the beginning of the collection.
...
The `toIterator` method converts the collection to a [`Iterator`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols#the_iterator_protocol).
...
The `concat` method concatenates multiple [`Iterable`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols#the_iterable_protocol)'s and returns a new collection.
...
The `difference` method will return the values in the original collection that are not present in [`Iterable`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols#the_iterable_protocol).
By default the equality check occurs on the item.
...
The `zip` method merges together the values of [`Iterable`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols#the_iterable_protocol) with the values of the collection at their corresponding index.
