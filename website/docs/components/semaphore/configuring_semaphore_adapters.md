...
:::info
The `NoOpSemaphoreAdapter` is useful when you want to mock out or disable your [`SemaphoreFactory`](https://eridu-tech.github.io/eridu-tech-core/classes/Semaphore.SemaphoreFactory.html) instance.
:::
