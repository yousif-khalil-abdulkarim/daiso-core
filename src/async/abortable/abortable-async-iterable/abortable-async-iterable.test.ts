...
import { abortableAsyncIterable } from "@/async/abortable/abortable-async-iterable/_module";

describe("function: abortableAsyncIterable", () => {
    test("should throw AsyncError when aborted", async () => {
        ...
        const outputIterable = abortableAsyncIterable(
            inputIterable,
