...
export type IReaderSemaphore = {
     ...
     */
    refreshReader(ttl?: TimeSpan): LazyPromise<boolean>;
...
export type IWriterLock = {
     ...
     */
    refreshWriter(ttl?: TimeSpan): LazyPromise<boolean>;
 ...
 * @group Contracts
 */
export type ISharedLockGetState = {
    /**
...
export type ISharedLockBase = IReaderSemaphore &
    IWriterLock & {
        foreceRelease(): LazyPromise<boolean>;
    };
 ...
 * @group Contracts
 */
export type ISharedLock = ISharedLockBase & ISharedLockGetState;
