...
export type ISemaphoreAdapter = {
     ...
     *
     * @returns Returns {@link ISemaphoreState | `ISemaphoreAdapterState`} if the semaphore exists in the database or null if doesnt exists.
     */
    getState(key: string): Promise<ISemaphoreState | null>;
};
