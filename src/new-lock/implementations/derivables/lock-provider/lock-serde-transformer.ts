...
import type { LockEvents } from "@/new-lock/contracts/_module-exports.js";
...
import type { ILockStateRecord } from "@/new-lock/implementations/derivables/lock-provider/lock-state.js";
