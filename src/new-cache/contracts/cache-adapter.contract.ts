 ...
 * @group Contracts
 */
export type CacheEntry<TType> = {
    value: TType;
    staleTtl: TimeSpan | null;
};
 ...
 * @group Contracts
 */
export type CacheAdapterAddSettings<TType = unknown> = {
    key: string;
    value: TType;
    ttl: TimeSpan | null;
    staleTtl: TimeSpan;
 ...
 * @group Contracts
 */
export type CacheAdapterUpdateAddSettings<TType = unknown> = {
    key: string;
    value?: TType;
    staleTtl?: TimeSpan | null;
};
 ...
 * @group Contracts
 */
export type CacheAdapterPutSettings<TType = unknown> = {
    key: string;
    value: TType;
    ttl: TimeSpan | null;
    staleTtl: TimeSpan | null;
 ...
 * @group Contracts
 */
export type CacheAdapterIncrementSettings = {
    key: string;
    value: number;
};
